...
export default function UnitTypeIcon({ icon, size, fill = '#ffffff' }: Props) {
  ...
  switch (icon) {
    ...
    case 'crossedSwords':
      // Crossed swords (game-icons.net, lorc, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'warAxe':
      // War axe (game-icons.net, delapouite, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'spears':
      // Crossed spears (game-icons.net, lorc, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'flangedMace':
      // Flanged mace (game-icons.net, delapouite, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'flail':
      // Flail (game-icons.net, delapouite, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'halberd':
      // Halberd (game-icons.net, lorc, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'warhammer':
      // Warhammer (game-icons.net, delapouite, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'woodClub':
      // Wooden club (game-icons.net, delapouite, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'trident':
      // Trident (game-icons.net, lorc, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'scythe':
      // Scythe (game-icons.net, lorc, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'glaive':
      // Glaive (game-icons.net, delapouite, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
    ...
    case 'spikedMace':
      // Spiked mace (game-icons.net, lorc, CC BY 3.0)
      return (
        <g transform={`scale(${size / 512}) translate(-256, -256)`}>
          <path
            fill={fill}
